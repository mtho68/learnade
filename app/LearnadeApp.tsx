  ...
  return <main className="study-shell" data-theme={theme}>
    ...
    <div className="study-layout">
      ...
      <section className="workspace">
        ...
        {mode === "reader" && <Reader learningPackage={learningPackage} title={title} target={readerTarget} onTargetChange={setReaderTarget} />}
        ...
        {mode === "exam" && <MockExam courseTitle={title} materials={materials} learnadeId={learnadeId} onReview={(id)=>{setReaderTarget(id);onChangeMode("reader")}} />}
      </section>
    </div>
  </main>;
}
...
function Reader({ learningPackage, title, target, onTargetChange }: { learningPackage:LearningPackage; title:string; target:string|null; onTargetChange:(target:string|null)=>void }) {
