...
- Acceptance criteria:
  ...
  - Honest first-run state and explicit demo selection.
  - Desktop, dark mode, reduced motion, and narrow-width support.
  - Passing automated tests and verified public deployment.
- Work items:
  - [x] Implement tour and first-run changes.
...
- Accounts, additional providers or modes, transcription expansion, and large on-device models.
