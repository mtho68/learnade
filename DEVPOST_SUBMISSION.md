...
During hands-on browser QA, Codex found and fixed two real defects that were not caught by the initial implementation: focus initially remained behind the overlay, and the adaptive-learning tooltip covered its highlighted Dashboard control at shorter viewport heights. Codex added regression coverage, ran the production build and all 23 automated tests, created the social preview metadata, and published Sites version 29.
